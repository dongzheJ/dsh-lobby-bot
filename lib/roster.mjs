  ...
  return {
    ...
    bots: bots
      ...
      .map((bot) => ({
        ...
        // The bot's own proof for `POST /api/bots/:id/token`. It has to survive
        // this whitelist: without it the prompt cannot tell the bot how to read a
        // room attachment, which is the whole reason the secret exists.
        exchangeSecret: typeof bot.exchangeSecret === "string" ? bot.exchangeSecret : "",
